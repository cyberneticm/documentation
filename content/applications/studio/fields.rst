...
- :guilabel:`Warning for future dates`: Enable this property to display a warning icon if a future
  date is selected.
- :guilabel:`numeric`: This property is disabled by default. By default the date will be shown as
  `Apr 2, 2025, 08:05 AM`. Enable this property to show the date in the format `4/2/2025 08:05:00`.
  The numeric mode is the value shown when editing the date. In this mode the seconds are always
  shown.
